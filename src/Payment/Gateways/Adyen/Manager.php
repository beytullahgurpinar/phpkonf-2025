...
namespace Payment\Gateways\Adyen;
...
class Manager extends PaymentAbstract implements PaymentInterface
{
    ...
    {
        $this->sendRequest('https://api.adyen.com/process', $paymentEntity->toArray());
        ...
        $paymentResponseEntity->setPaymentMethod('adyen');
    ...
    {
        $this->sendRequest('https://api.adyen.com/refund', $refundEntity->toArray());
