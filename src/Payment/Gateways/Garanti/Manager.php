...
namespace Payment\Gateways\Garanti;
...
class Manager extends PaymentAbstract implements PaymentInterface
{
    ...
    {
        $this->sendRequest('https://api.garanti.com/process', $paymentEntity->toArray());
        ...
        $paymentResponseEntity->setPaymentMethod('garanti');
    ...
    {
        $this->sendRequest('https://api.garanti.com/refund', $refundEntity->toArray());
