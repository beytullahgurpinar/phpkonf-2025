...
namespace Payment\Gateways\Paypal;
...
class Manager extends PaymentAbstract implements PaymentInterface
{
    ...
    {
        $this->sendRequest('https://api.paypal.com/process', $paymentEntity->toArray());
        ...
        $paymentResponseEntity->setPaymentMethod('paypal');
    ...
    {
        $this->sendRequest('https://api.paypal.com/refund', $refundEntity->toArray());
